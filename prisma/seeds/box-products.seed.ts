...
export async function seedBoxProducts(prisma: PrismaClient) {
  ...
  const boxProductsData = [
    ...
    {
      id: BOX_PRODUCT_IDS.RL_3_WHITE_CARTRIDGES,
      name: "3RL White Cartridges",
      quantity: 30,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RL_5_WHITE_CARTRIDGES,
      name: "5RL White Cartridges",
      quantity: 25,
      date: new Date(),
      boxId: BOX_IDS.WHITE_RL_1,
      productId: PRODUCT_IDS.RL_5,
    ...
    {
      id: BOX_PRODUCT_IDS.RL_9_CARTRIDGES,
      name: "9RL Cartridges",
      quantity: 35,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RL_11_CARTRIDGES,
    ...
    {
      id: BOX_PRODUCT_IDS.RS_3_CARTRIDGES,
      name: "3RS Cartridges",
      quantity: 40,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RS_5_CARTRIDGES,
      name: "5RS Cartridges",
      quantity: 35,
      date: new Date(),
      boxId: BOX_IDS.BLACK_RS_1,
    ...
    {
      id: BOX_PRODUCT_IDS.RS_7_CARTRIDGES,
      name: "7RS Cartridges",
      quantity: 30,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RS_9_CARTRIDGES,
      name: "9RS Cartridges",
      quantity: 25,
      date: new Date(),
      boxId: BOX_IDS.BLACK_RS_2,
    ...
    {
      id: BOX_PRODUCT_IDS.RM_5_CARTRIDGES,
      name: "5RM Cartridges",
      quantity: 30,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RM_7_CARTRIDGES,
      name: "7RM Cartridges",
      quantity: 25,
      date: new Date(),
      boxId: BOX_IDS.BLACK_RM_1,
    ...
    {
      id: BOX_PRODUCT_IDS.RM_9_CARTRIDGES,
      name: "9RM Cartridges",
      quantity: 20,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.RM_11_CARTRIDGES,
    ...
    {
      id: BOX_PRODUCT_IDS.M1_5_CARTRIDGES,
      name: "5M1 Cartridges",
      quantity: 25,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.M1_7_CARTRIDGES,
      name: "7M1 Cartridges",
      quantity: 20,
      date: new Date(),
      boxId: BOX_IDS.BLACK_M1_1,
    ...
    {
      id: BOX_PRODUCT_IDS.M1_9_WHITE_CARTRIDGES,
    ...
    {
      id: BOX_PRODUCT_IDS.BLACK_PAINT_1,
      name: "Black Paint",
      quantity: 10,
      date: new Date(),
    ...
    {
      id: BOX_PRODUCT_IDS.TRANSFER_GEL_1,
      name: "Transfer Gel",
      quantity: 8,
      date: new Date(),
      boxId: BOX_IDS.DARK_BLUE_BOX_1,
    ...
    {
      id: BOX_PRODUCT_IDS.BOX_PRODUCT_1,
      name: "Box Product",
      quantity: 15,
      date: new Date(),
      boxId: BOX_IDS.MAST_BLUE_1,
    ...
    {
      id: BOX_PRODUCT_IDS.DYNAMIC_RL_3_1,
      name: "Dynamic 3RL",
      quantity: 20,
      date: new Date(),
      boxId: BOX_IDS.GREEN_BOX_TABLE_1,
      productId: PRODUCT_IDS.DYNAMIC_RL_3,
      purchasePrice: 270,
      status: "active",
    },
    {
      id: BOX_PRODUCT_IDS.DYNAMIC_RL_5_1,
      name: "Dynamic 5RL",
      quantity: 18,
      date: new Date(),
      boxId: BOX_IDS.GREEN_BOX_TABLE_1,
      productId: PRODUCT_IDS.DYNAMIC_RL_5,
      purchasePrice: 290,
      status: "active",
    },
    {
      id: BOX_PRODUCT_IDS.DYNAMIC_RL_7_1,
      name: "Dynamic 7RL",
      quantity: 15,
      date: new Date(),
      boxId: BOX_IDS.GREEN_BOX_TABLE_1,
      productId: PRODUCT_IDS.DYNAMIC_RL_7,
      purchasePrice: 310,
      status: "active",
    },
  ];
